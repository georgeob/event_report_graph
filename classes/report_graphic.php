...
class report_graphic extends Gcharts
{
    ...
    /**
     * Get Users that are enrolled in the selected course
     *
     */

    public function get_course_enrolled_users()
    {
     /*   global $DB;
