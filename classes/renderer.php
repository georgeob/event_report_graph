...
class report_graphic_renderer extends plugin_renderer_base
{
    ...
    /**
    This function is used to generate and display course enrolled users
     */

    public function enrolled_users_form()
    {
        $renderable = $this->renderable;
        ...
        echo html_writer::select($users,"id",$selecteduser,null,array('id'=>'name'));
        echo html_writer::empty_tag('input', array('type' => 'submit', 'value' => get_string('useractivityselect','report_graphic')));
        echo html_writer::end_div();
        echo html_writer::end_tag('form');
    }
